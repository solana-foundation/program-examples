...
impl PoolInitializedEvent {
    ...
    pub fn new(admin: Address, operator: Address, entry_fee: u64, settle_deadline_slots: u64, tier_count: u8) -> Self {
        Self { admin, operator, entry_fee, settle_deadline_slots, tier_count }
    }
}
